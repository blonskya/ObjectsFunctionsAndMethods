...
def try_methods_and_functions():
    ...
    #
    ####################################################################
    Venus=rg.SimpleTurtle()
    Venus.backward(150)
    Venus.speed=1
    Venus.pen=rg.Pen('blue',5)
    draw_many_squares(Venus,2,100,30)
    Venus.speed=5
    Venus.pen=rg.Pen('red',5)
    draw_many_squares(Venus,10,50,15)
    Venus.speed=100
    Venus.pen=rg.Pen('red',35)
    draw_many_squares(Venus,8,300,60)
    Venus.pen=rg.Pen('black',3)
    Venus.backward(200)
    Venus.draw_circle(30)
    Venus.draw_square(50)
# ----------------------------------------------------------------------
