...
def turtle4():
    ...
    Lucy.pen = rg.Pen('Misty Rose', 20)

    Lucy.backward(300)

    Lucy.begin_fill()
    Lucy.draw_circle(100)
    Lucy.end_fill()
...
def turtle5():
    ...
    and then draw a black-filled circle.
    """
    Iron = rg.SimpleTurtle()
    Iron.pen = rg.Pen('PapayaWhip', 10)

    Iron.right(90)
    Iron.forward(200)

    Iron.begin_fill()
    Iron.draw_regular_polygon(10,20)
    Iron.end_fill()

    Steel = rg.SimpleTurtle()
    Steel.pen=rg.Pen('AliceBlue',20)

    Steel.left(90)
    Steel.forward(100)
    Steel.begin_fill()
    Steel.draw_square(20)
    Steel.end_fill()
########################################################################
#
# Done: 2.
