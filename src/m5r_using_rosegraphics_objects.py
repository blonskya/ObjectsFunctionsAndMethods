...
#            basically it refreshes the window to display new things.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            It's needed when you want the user to be able to close the window when they click,
#               so that the code can progress easily.
#
